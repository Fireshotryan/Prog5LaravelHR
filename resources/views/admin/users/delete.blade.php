...
<div class="container mx-1">
    ...
    @if (!empty($users->getRoleNames()))
        @foreach ($users->getRoleNames() as $v)
            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" name="email" id="email" value="{{ $v }}" type="text" disabled>
        @endforeach
    @endif
</div>
    <div class="mb-4">
